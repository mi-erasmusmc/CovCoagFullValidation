...
#
# This file is part of CovCoagFullValidation
#
...
OhdsiRTools::checkUsagePackage("CovCoagFullValidation")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/CovCoagFullValidation.pdf")
shell("R CMD Rd2pdf ./ --output=extras/CovCoagFullValidation.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "CovCoagFullValidation")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("CovCoagFullValidation")
